...
control Bf2BloomFilter(in bf2_key_t ds_key,
    ...
    table tbl_set_win {
        ...
        const entries = {
            (INSERT, 16w0 .. 16w7152) : act_set_clear_win_1(CLEAR,
                                                            NOOP,
                                                            NOOP,
                                                            INSERT);
            (INSERT, 16w7153 .. 16w14305) : act_set_clear_win_2(INSERT,
                                                                CLEAR,
                                                                NOOP,
                                                                NOOP);
            (INSERT, 16w14306 .. 16w21458) : act_set_clear_win_3(NOOP,
                                                                 INSERT,
                                                                 CLEAR,
                                                                 NOOP);
            (INSERT, 16w21459 .. 16w28611) : act_set_clear_win_4(NOOP,
                                                                 NOOP,
                                                                 INSERT,
                                                                 CLEAR);
            (QUERY, 16w0 .. 16w7152) : act_set_clear_win_1(CLEAR,
                                                           QUERY,
                                                           QUERY,
                                                           QUERY);
            (QUERY, 16w7153 .. 16w14305) : act_set_clear_win_2(QUERY,
                                                               CLEAR,
                                                               QUERY,
                                                               QUERY);
            (QUERY, 16w14306 .. 16w21458) : act_set_clear_win_3(QUERY,
                                                                QUERY,
                                                                CLEAR,
                                                                QUERY);
            (QUERY, 16w21459 .. 16w28611) : act_set_clear_win_4(QUERY,
                                                                QUERY,
                                                                QUERY,
                                                                CLEAR);
            (_, _) : .NoAction();
...
control SwitchIngress(inout header_t hdr,
    ...
    action bf2_act_set_key_1(bit<8> api) {
        ig_md.bf2_api = api;
        ig_md.bf2_key = (hdr.ipv4.dst_addr ++ hdr.ipv4.src_addr);
    }
    action bf2_act_set_key_2(bit<8> api) {
        ig_md.bf2_api = api;
    ...
    table bf2_tbl_set_key {
        ...
        const entries = {
            32w2154823680 &&& 32w4294901760 : bf2_act_set_key_1(INSERT);
            32w2360606720 &&& 32w4294901760 : bf2_act_set_key_1(INSERT);
            32w3432591360 &&& 32w4294966784 : bf2_act_set_key_1(INSERT);
            32w1119137792 &&& 32w4294967040 : bf2_act_set_key_1(INSERT);
            32w1119138048 &&& 32w4294967040 : bf2_act_set_key_1(INSERT);
            32w1119138816 &&& 32w4294966272 : bf2_act_set_key_1(INSERT);
            _ : bf2_act_set_key_2(QUERY);
        }
        default_action = bf2_act_set_key_2(QUERY);
        size = 7;
    }
